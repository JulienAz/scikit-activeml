...
if __name__ == '__main__':
    ...
    f = sb.relplot(data=df, x=TIMESTEP, y=ACCURACY, kind="line", hue=N_CLUSTER, col=CLU_TIMEWINDOW, row=BUDGET, errorbar=None, palette='tab10')
    #f.set(title='Accuracy')

    image_filepath = os.path.join(this_dir, "..", "..", target_directory, 'output_acc_over_time_per_clustering_timewindow.pdf')
